export const RADIO_CHANNELS = [
  { id: 'lofi-hiphop', label: 'Lofi Hip Hop Radio', videoId: 'rFZHOHl-L8A' },
  ...
  { id: 'study-with-me', label: 'Study Pomodoro Radio', videoId: 'qGohtGC5Rtk' },
  { id: 'christmas-lofi', label: 'Christmas Lofi Radio', videoId: 'XSXEaikz0Bc' },
  { id: 'halloween-lofi', label: 'Halloween Lofi Radio', videoId: '3GQY80jyysQ' },
  { id: 'fireplace-ambience', label: 'Fireplace Ambient Radio', videoId: 'q_4KI-ChIIs' },
  ...
  { id: 'gentle-rain', label: 'Rain Ambient Music', videoId: '-OekvEFm1lo' },
